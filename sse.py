...
from quart import Blueprint, request, current_app, json, stream_with_context
...
class ServerSentEventsBlueprint(Blueprint):
    ...
    def stream(self):
        ...
        # https://github.com/singingwolfboy/flask-sse/issues/34
